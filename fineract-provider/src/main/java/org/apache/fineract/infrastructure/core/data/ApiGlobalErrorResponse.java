...
public class ApiGlobalErrorResponse {
    ...
    public static ApiGlobalErrorResponse domainRuleViolation(final String globalisationMessageCode, final String defaultUserMessage,
        ...
        globalErrorResponse.setDeveloperMessage("Permintaan dipahami tetapi menyebabkan pelanggaran aturan domain."); // add
                                                                                                                      // by
                                                                                                                      // natha
        ...
        globalErrorResponse.setDefaultUserMessage("Kesalahan mengandung alasan pelanggaran aturan domain."); // add by
                                                                                                             // natha
